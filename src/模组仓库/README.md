...
冲突：[Phosphor](https://modrinth.com/mod/phosphor)
...
简介：将 OptiFine 的大部分眼花缭乱的选项带到 Sodium ，还提供一些视觉错误修复和其他性能选项等 Sodium 上尚未提供的功能
...
<img src=https://cdn.modrinth.com/data/Bh37bMuy/icon.png alt=icon height=64 width=64>

模组ID：`reeses-sodium-options`
...
<img src=https://cdn.modrinth.com/data/NNAgCjsB/icon.png alt=icon height=64 width=64>

模组ID：`entityculling`

简介：使用异步路径跟踪来跳过不可见的方块/实体
...
<img src=https://cdn.modrinth.com/data/fQEb0iXm/icon.png alt=icon height=64 width=64>

模组ID：`krypton`

简介：优化 Minecraft 网络堆栈
...
<img src=https://cdn.modrinth.com/data/752GQt04/146f007db0b7a9021fe9e304de94d7c444333f2b.jpeg alt=icon height=64 width=64>

模组ID：`imblocker`

简介：识别当前游戏状态，并自动启用/禁用输入法
...
简介：重新实现了MCPatcher的CIT（OptiFine资源包的自定义物品纹理）
...
<img src=https://cdn.modrinth.com/data/yBW8D80W/icon.png alt=icon height=64 width=64>

模组ID：`lambdynamiclights`
...
下载：[2.2.0](https://cdn.modrinth.com/data/yBW8D80W/versions/9E1ECN95/lambdynamiclights-2.2.0%2B1.19.3.jar)

链接：[GitHub](https://github.com/LambdAurora/LambDynamicLights) [Modrinth](https://modrinth.com/mod/lambdynamiclights) [CurseForge](https://www.curseforge.com/minecraft/mc-mods/lambdynamiclights)
...
下载：[1.1.1](https://cdn.modrinth.com/data/sGmHWmeL/versions/1.1.1%2B1.17/mixintrace-1.1.1%2B1.17.jar)
